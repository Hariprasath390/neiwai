  ...
  return (
    <div className="bg-[rgb(255,255,255)]">
      <div className="flex ml-4  ">
        <div className="mt-40">
          <Fragment className="text-sm  ml-5">
            <Accordion open={open === 1} icon={<Icon id={1} open={open} />} className="h-32">
              <AccordionHeader onClick={() => handleOpen(1)}>
                <h2 className="ml-2 font-medium "> COLOR </h2>
              </AccordionHeader>
              <AccordionBody className="w-48 h-48 hidden md:block ">
            ...
            <Accordion open={open === 2} icon={<Icon id={2} open={open} />} className="mt-6">
            <hr className="border-[rgb(227,227,227)]  mt-8" />
              <AccordionHeader onClick={() => handleOpen(2)} className="mt-4">
                <h2 className="ml-2 font-medium"> SIZE </h2>
              </AccordionHeader>
              <AccordionBody className=" h-full ">
                <div className="mt-6 ">
