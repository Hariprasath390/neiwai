...
import dress1 from "../src/images/dress1.png";
import dress2 from "../src/images/dress2.png";
import dress3 from "../src/images/dress3.png";
import dress4 from "../src/images/dress4.png";
    ...
    <div>
      ...
      <div className="border-1 p-4 border-gray-300 bg-white">
        <div className="flex justify-between">
          <img className="md:w-28" src={neiwai} alt="img" />
          <div className=""><ul className=" sm:flex  justify-evenly w-full flex-wrap mt-2 space-x-4 cursor-pointer mr-5 text-gray-900 hidden ">
            <li className="">NEW</li>
            <li className="">SALE</li>
            <li className="">GIFTS</li>
            <li className="">BEST SELLERS</li>
            <li className="">UNDERWEAR</li>
            <li className="">LOUNGE</li>
            <li className="">ACTIVE</li>
            <li className="">FOR HIM</li>
      ...
      <div className="bg-[rgb(249,247,240)] py-36 w-full p-3">
        <h2 className=" w-full inline-flex justify-center items-center mb-12 text-4xl ">
          BEST SELLERS
        </h2>
        <div className=" flex mt-12 justify-evenly "><img className="h-96 w-90 b-2 " src={dress1} alt="img" /> 
        <img className="w-90 h-96 " src={dress2} alt="img" />
        <img className="w-90 h-96" src={dress3} alt="img" />
        <img className="w-90 h-96" src={dress4} alt="img" /></div>
      </div>

      <div className="flex justify-evenly flex-wrap  mt-28 xl:flex xl:flex-wrap w-full">
        <div className="group ">
          ...
          <div className="flex items-center sm: justify-start md:justify-start m-3 w-full lg:w-52">
            <div className=" group w-full mb-4 md: flex-wrap p-1 ">
              <div className="flex">
                ...
                <AiOutlineDown className=" lg:hidden sm:ml-2] " />
              </div>
